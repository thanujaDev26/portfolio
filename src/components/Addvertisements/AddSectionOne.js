                        ...
                        <div className="mt-8">
                            ...
                            {isNotified ? (
                                ...
                                <form onSubmit={handleNotifySubmit}
                                    ...
                                    <button
                                        type="submit"
                                        className="neon-hover text-lg border-2 border-black hover:border-cyan-500 rounded-full px-4 py-2 hover:text-cyan-500 transition-all duration-300 ease-in-out"
                                    >
                                        Notify
                                    </button>
                                </form>
